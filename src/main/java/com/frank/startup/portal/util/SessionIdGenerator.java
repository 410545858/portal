...
/*
 * Licensed to the Apace Software Foundation (ASF) under one or more
...
public class SessionIdGenerator {
	...
	private static SessionIdGenerator sessionIdGenerator = null;
	...
	public static void main(String[] args) {
		System.out.println(SessionIdGenerator.getInstance().generateSessionId());
	}
}
